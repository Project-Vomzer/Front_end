  ...
  if (loading) {
    return (
      <div className="space-y-4 p-4 h-[calc(100vh-4rem)] overflow-y-auto">
        <div className="bg-white rounded-xl p-4 shadow-sm h-40 flex items-center  animate-pulse justify-center">
          {/* Loading data... */}
        </div>
        <div className="bg-white rounded-xl p-4 shadow-sm h-48 flex items-center  animate-pulse justify-center">
          {/* Loading data... */}
        </div>
        <div className="bg-white rounded-xl p-4 shadow-sm h-60 flex items-center  animate-pulse justify-center">
          {/* Loading data... */}
        </div>
      </div>
    );
